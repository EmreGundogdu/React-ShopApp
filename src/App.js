...
export default class App extends Component {
  ...
  render() {
    let productInfo = { title: "Product Listesi" }
    let categoryInfo = { title: "Category Listesi" }
    return (
      <div>
        <Container>
            ...
            <Col xs="9">
              <Switch>
                <Route exact path="/" render={props => (
                  <ProductList {...props} products={this.state.products} addToCart={this.addToCart} currentCategory={this.state.currentCategory} info={productInfo} />
                )
